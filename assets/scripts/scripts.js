...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is ryan.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at University of Phoenix")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm studying IT Management Systems")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like karaoke.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
